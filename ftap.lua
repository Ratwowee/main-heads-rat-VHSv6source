...
local Window = Rayfield:CreateWindow({
    Name = "VHS V6 cracked source",
    Icon = 0,
    LoadingTitle = "Open source",
    LoadingSubtitle = "cracked by Jose",
    Theme = "Ocean",
...
if L.vhsows then
	local debugtab = Window:CreateTab("Debug", 7743876054)
		...
		debugtab:CreateSection("Target")
			...
			local debugl = debugtab:CreateLabel("Hello, welcome to VHS V6!")
...
local grabtab = Window:CreateTab("Grab & Lines", 7733954884)
...
local liststab = Window:CreateTab("List", 7733674079)
...
Modules.DisplayMessage("Made by You", "16")
local Modules = {}
Modules.Services = {
    RunService = game:GetService("RunService"),
    StarterGui = game:GetService("StarterGui")
...
Modules.DisplayMessage("Main", "#Header 1", "#")
